...
var JqueryUiForms = function() {
    ...
    var _componentUiDatepicker = function() {
        ...
        $('.datepicker-icon').datepicker({
            showOn: 'button',
            buttonImage: '../../../admin/images/ui/datepicker_trigger.png',
    ...
    var _componentUiAutocomplete = function() {
        ...
        $.widget('custom.catcomplete', $.ui.autocomplete, {
            _create: function() {
                this._super();
                this.widget().menu('option', 'items', '> :not(.ui-autocomplete-categories)');
            },
            _renderMenu: function(ul, items) {
                ...
                $.each( items, function(index, item) {
                    ...
                    if (item.category != currentCategory) {
                        ul.append('<li class="ui-autocomplete-categories">' + item.category + '</li>');
        ...
        $('#ac-remote').autocomplete({
            minLength: 2,
            source: '../../../admin/demo_data/jquery_ui/autocomplete.php',
            search: function() {
        ...
        $('#ac-caching').autocomplete({
            ...
            source: function(request, response) {
                ...
                $.getJSON('../../../admin/demo_data/jquery_ui/autocomplete.php', request, function(data, status, xhr) {
                    cache[ term ] = data;
                    response(data);
                });
            },
