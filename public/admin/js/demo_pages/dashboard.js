...
var Dashboard = function () {
    ...
    var _TrafficSourcesStreamChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.csv('../../../admin/demo_data/dashboard/traffic_sources.csv', function (error, data) {
    ...
    var _AppSalesLinesChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.csv('../../../admin/demo_data/dashboard/app_sales.csv', function(error, data) {
                formatted = data;
                redraw();
            });
    ...
    var _MonthlySalesAreaChart = function(element, height, color) {
        ...
        if($(element).length > 0) {
            ...
            d3.json('../../../admin/demo_data/dashboard/monthly_sales.json', function (error, data) {
    ...
    var _AppSalesHeatmap = function(element) {
        ...
        if($(element).length > 0) {
            ...
            // Load data
            d3.csv('../../../admin/demo_data/dashboard/app_sales_heatmap.csv', function(error, data) {
    ...
    var _BulletChart = function(element, height) {
        ...
        if($(element).length > 0) {
            ...
            d3.json('../../../admin/demo_data/dashboard/bullets.json', function(error, data) {
